...
create table chemistmaster(stateCode varchar2(50),hqcode varchar2(50),citycode varchar2(50),areacode varchar2(50),name varchar2(50),addr varchar2(50),dob date,doa date,phone varchar2(50),mobile varchar2(50),marital char(1) check(marital in('Y','y','N','n')),sex char(1) check (sex in ('M','m','F','f')),constraint pk_chemistmaster primary key(statecode,hqcode,citycode,areacode,name));

create table stockistmaster(statecode varchar2(40),hqcode varchar2(50),citycode varchar2(50),areacode varchar2(50),name varchar2(50),addr varchar2(50),dob date,doa date,phone varchar2(50),mobile varchar2(50),marital char(1) check(marital in('Y','y','N','n')), sex char(1) check (sex in('M','m','F','f')),constraint pk_stockistmaster primary key(statecode,hqcode,citycode,areacode,name));
...
create table usermaster(groupname varchar2(50),hqname varchar2(50),statename varchar2(50),loginid varchar2(20),loginpassword varchar2(20),firstname varchar2(50),lastname varchar2(50),fathername varchar2(50),dob date,mailaddress varchar2(50),parmanentaddress varchar2(50),phonenumber varchar2(50),mobilenumber varchar2(50),sex char(1) check(sex in('M','m','F','f')),maritalstatus char(1) check(maritalstatus in ('Y','y','N','n')),doa date,doj date,basic number(15,2),hra number(15,2),eallowance number(15,2),communication number(15,2),vma number(15,2),cca number(15,2),userstatus char(1) check(userstatus in ('A','D')));
...
create table primarytarget(groupname varchar2(50),hqname varchar2(50),statename varchar2(50),areacode varchar2(50),loginid varchar2(20),productname varchar2(50),mthlastdate date,qty number(15,2));
